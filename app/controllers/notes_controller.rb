class NotesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @note.save
        format.html { redirect_to authenticated_root_path(), notice: 'Note was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @note.update(note_params)
        format.html { redirect_to authenticated_root_path(), notice: 'Note was successfully updated.' }
  ...
  def destroy
    @note.destroy
    respond_to do |format|
      format.html { redirect_to authenticated_root_path(), notice: 'Note was successfully destroyed.' }
